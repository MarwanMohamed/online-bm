...
return [
    ...
    /**
     * Enable backups cronjob.
     */
    'cronjob' => env('BACKUP_CRONJOB', false),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_EMAILS') ? explode(',', env('BACKUP_EMAILS')) : [],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'keep_daily_backups_for_days' => 32,
             ...
             */
            'keep_monthly_backups_for_months' => 8,

            /*
             * The number of years for which one yearly backup must be kept.
             */
            'keep_yearly_backups_for_years' => 4,
