...
<html lang="en" style="min-height:100%">
  ...
  <meta charset="utf-8">
    ...
    <title>
        <?= (!empty($title)) ? $title : 'Qatar Bima Online Insurance'; ?>
    </title>
    <!-- Bootstrap -->
        ...
        <nav class="navbar navbar-light" data-spy="affix" data-offset-top="50">
          <div class="container">
            ...
            <a class="navbar-brand" href="{{asset('/')}}">
              <img class="img-responsive" src="{{asset('/assets/img/logo.png')}}" alt="" style="height:inherit">
            </a>
            <div class="collapse navbar-toggleable-sm pull-xs-left pull-md-right" style="padding-top: 20px;" id="main-menu" >
              <div style="display:none;" class="navigation">
{{--                !empty($this->session->userdata('userData'))) --}}
                <ul class="nav nav-inline">
                  <li class="nav-item dropdown"><a href="#" data-toggle="modal" data-target="#loginModal"><i class="fa fa-key">&nbsp;</i><strong>Login (دخول)</strong></a></li>
                  <li class="nav-item dropdown"><a href="#" data-toggle="modal" data-target="#registerModal"><i class="fa fa-user">&nbsp;</i><strong>Register (تسجيل)</strong></a></li>
                </ul>
              </div>
              <div style="display:none;" class="navigation">
{{--                !empty($this->session->userdata('userData'))) --}}
                <ul class="nav nav-inline">
                  <li><a href="{{asset('/dashboard/myprofile')}}"><strong><i class="fa fa-user"></i>&nbsp;My Profile</strong></a></li>
                  <li><a href="{{asset('/dashboard')}}"><strong><i class="fa fa-dashboard"></i>&nbsp;Dashboard</strong></a></li>
                  <li><a href="{{asset('/dashboard/logout')}}"><strong>Logout</strong>&nbsp;<i class="fa fa-sign-out"></i></a></li>
                </ul>
              </div>
              <br><br><div class="text-center" style="color:#5cb85c"><strong> {{-- ($this->session->userdata('welcome'))--}}  </strong></div>
                  ...
                  <div class="modal-content">
                    <form id="logFrm" class="cmxform">
                      ...
                      <div class="modal-header">
                        ...
                        <h6 class="col-md-12" style="font-size:14px">Please enter your login credentials</h6>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            ...
                            <div class="col-md-12 col-height">
                              <input type="text" class="form-control-1" name="logUsername" id="logUsername" placeholder="Username">
                            </div>
                            <div class="col-md-12 col-height">
                              <input type="password" class="form-control-1" name="logPwd" id="logPwd" placeholder="Password">
                            </div>
                            <div class="col-md-12 col-height">
                              <span class="text-center"><a href="{{asset('/')}}/customer/forgot">Forgot Password?</a></span>
                            </div>
                          </div>
                          <div class="col-md-2"></div>
                        </div>
                      ...
                      <div class="modal-footer">
                        <input type="submit" class="btn btn-danger" name="logSubmit" id="logSubmit" value="Submit">
                      </div>
                    </form>
                  </div>
                </div>
                  ...
                  <div class="modal-content">
                    <form id="regFrm" class="cmxform">
                      ...
                      <div class="modal-header">
                        ...
                        <button type="button" class="close col-md-1" data-dismiss="modal">&times;</button>
                        <h6 class="col-md-12" style="font-size:14px">Please enter your correct information to register with us</h6>
                      ...
                      <div class="modal-body">
                        <div class="row col-md-12">
                          <div class="col-md-6">
                            <div class="radio">
                              <label><input type="radio" name="ownerTypeR"  value="I" checked> Individual</label>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="radio">
                        ...
                        <div class="row col-md-12">
                          <div class="col-md-6 col-height">
                            <input type="text" class="form-control-1" name="reg_fullname" id="reg_fullname" placeholder="Full Name">
                          </div>
                          <div class="col-md-6 col-height">
                            <input type="text" class="form-control-1" name="reg_username" id="reg_username" placeholder="Username">
                          </div>
                        </div>
                        <div class="row col-md-12">
                          ...
                          <div class="col-md-6 col-height">
                            <input type="password" class="form-control-1" name="confirm_pwd" id="confirm_pwd" placeholder="Confirm Password">
                          </div>
                        </div>
                        <div class="row col-md-12">
                          <div class="col-md-6 col-height">
                            <input type="email" class="form-control-1" name="reg_email" id="reg_email" placeholder="Email">
                          </div>
                          <div class="col-md-6 col-height" id="establishQR">
                            <input type="text" class="form-control-1" name="reg_qid" id="reg_qid" maxlength="11" placeholder="Qatar ID">
                          </div>
                          <div class="col-md-6" id="establishER" style="display:none;">
                              <input type="text" class="form-control-1" name="reg_establish_id" placeholder="Establish Id" id="reg_establish_id" maxlength="8">
                          </div>
                        </div>
                        <div class="row col-md-12">
                          <div class="col-md-6 col-height">
                            <input type="text" class="form-control-1" name="reg_mobile" id="reg_mobile" placeholder="Mobile Number" maxlength="8">
                          </div>
                      ...
                      <!-- Modal footer -->
                      <div class="modal-footer">
                        <input type="submit" name="regSubmit" id="regSubmit" class="btn btn-danger" value="Submit">
                      </div>
                    </form>
                  </div>
                </div>
    ...
    <div class="row text-center">
      <div style="min-height: 250px;">
        <div style="margin-top: 4%;">
          <!-- Code is here -->
          <div class="col-md-4">
            <a class="newInsurance" href="{{asset('/insurance/new')}}"><img  type="image" src="{{asset('/assets/img/newmotor.png')}}" alt="..." class="img-thumbnail homepage-icons"></a>
            <br><a class="newInsurance icon-label">تأمين السيارات<br>New Motor Insurance</a>
          </div>
          <div class="col-md-4">
            <a class="reNewInsurance" href="{{asset('/renew')}}"><img  type="image" src="{{asset('/assets/img/renewmotor.png')}}" alt="..." class="img-thumbnail homepage-icons"></a>
            <br><a class="reNewInsurance icon-label">تجديد تأمين السيارات<br>Renew Motor Insurance</a>
          </div>
          <div class="col-md-4">
            <a class="makePayment" href="{{asset('/payment/quickpay')}}"><img  type="image" src="{{asset('/assets/img/payment.png')}}" alt="..." class="img-thumbnail homepage-icons"></a>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <p class="copyright-text">
            &copy; {{date("Y")}} Qatar Bima International W.L.L - Design and Development by <a
                    style="color:#fff; font-weight:600" href="http://bluelynx.qa" target="_blank">Blue Lynx </a>
          </p>
        </div>
      </div>
    </div>
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          if (res.success == true) {
            ...
            $('#registerModal').hide();
            window.location.href = "{{asset('/customer')}}";
          } else {
