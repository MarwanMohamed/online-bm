...
@section('content')
    ...
    <div id="free-promo">
        <form id="thirdPartFrm" autocomplete="off" name="thirdPartFrm" action="/insurance/confirm" method="post">
            @csrf
            <!-- Hidden fields for insurance data -->
            <input type="hidden" name="com_id" id="com_id" value="{{ $insurance->com_id ?? '' }}">
            <input type="hidden" name="area" id="area" value="{{ $insurance->area ?? '' }}">
            <input type="hidden" name="owner_type" value="{{ $insurance->owner_type ?? 'I' }}">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="nmi_fullname" id="chngeOwnerF">Name</label><label class="pull-right"
                                                                                               for="nmi_fullname">الاسم
                                </label>
                            <input type="text" class="form-control" name="name" id="nmi_fullname" value="{{ $insurance->name ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-4" id="establishQ">
                        <div class="form-group">
                            <label for="qid" id="chngeOwnerQ">Qatar ID</label><label class="pull-right" for="qid">رقم
                                البطاقة</label>
                            <input value="{{ $insurance->qid ?? '' }}" type="text" class="form-control" name="qid" id="qid" maxlength="11">
                        </div>
                    </div>
                    <div class="col-md-4" id="establishE" style="display:none;">
                        <div class="form-group">
                            <label for="eid" id="chngeOwnerQ">Establishment ID</label><label class="pull-right"
                                ...
                                قيد المنشأة</label>
                            <input type="text" value="{{ $insurance->qid ?? '' }}" class="form-control" name="eid" id="eid" maxlength="8">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="nmi_email">Email</label><label class="pull-right" for="email">البريد
                                الإلكتروني</label>
                            <input type="email" class="form-control" name="email" id="email" value="{{ $insurance->email ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-4" id="phoneInd">
                        <div class="form-group">
                            <label for="phone">Phone #</label><label class="pull-right" for="phone">رقم الهاتف</label>
                            <input type="tel" class="form-control" name="phone" id="phone" maxlength="8" value="{{ $insurance->phone ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="mobile">Mobile #</label><label class="pull-right" for="mobile">رقم
                                الجوال</label>
                            <input type="tel" class="form-control" id="mobile" name="mobile" maxlength="8" value="{{ $insurance->mobile ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-4" id="posboxOrg" style="display: none;">
                        <div class="form-group">
                            <label for="pb_no">P.O Box #</label><label class="pull-right" for="pb_no">صندوق
                                البريد</label>
                            <input type="text" class="form-control" id="pb_no" name="pb_no" maxlength="8" value="{{ $insurance->pb_no ?? '' }}">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_reg_no">Plate No. #</label><label class="pull-right" for="vhl_reg_no">رقم اللوحة</label>
                                <input type="text" class="form-control" name="vhl_reg_no" id="vhl_reg_no" value="{{ $insurance->vhl_reg_no ?? '' }}" readonly="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_reg_no">Make</label><label class="pull-right" for="vhl_reg_no">نوع السيارة</label>
                                <input type="text" class="form-control" name="vhl_make" id="vhl_make" value="{{ $insurance->vhl_make ?? '' }}" readonly="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_class">Model</label><label class="pull-right" for="vhl_class">الطراز</label>

                                <input type="text" class="form-control" name="vhl_class" id="vhl_class" value="{{ $insurance->vhl_class ?? '' }}" readonly="">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_chassis">Chassis #</label><label class="pull-right" for="vhl_chassis">رقم الشاصي</label>
                                <input type="text" class="form-control" id="vhl_chassis" name="vhl_chassis" value="{{ $insurance->vhl_chassis ?? '' }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_engine">Engine #</label><label class="pull-right" for="vhl_engine">رقم المحرك</label>
                                <input type="text" class="form-control" name="vhl_engine" id="vhl_engine" value="{{ $insurance->vhl_engine ?? '' }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="vhl_engine">Color</label><label class="pull-right" for="vhl_engine">اللون</label>
                                <input type="text" class="form-control" name="vhl_color" id="vhl_color" value="{{ $insurance->vhl_color ?? '' }}">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="vhl_year" id="vhl_year">
                                    ...
                                    @for ($y = $tenYearBack; $y <= $currentYear; $y++)
                                        <option value="{{$y}}" {{ ($insurance->vhl_year ?? '') == $y ? 'selected' : '' }}>{{$y}}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="start_date">Start date </label><label class="pull-right" for="start_date">تاريخ بداية التأمين </label>
                                <input type="text" readonly="" class="form-control hasDatepicker valid" name="start_date" id="start_date" value="{{ $insurance->start_date ?? '' }}" aria-invalid="false">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="end_date">End date</label><label class="pull-right" for="end_date">تاريخ نهاية التأمين</label>
                            <input type="text" readonly="" class="form-control" name="end_date" id="end_date" value="{{ $insurance->end_date ?? '' }}">
                        </div>
                    </div>
                ...
                <div class="row" id="mainCalc">
                    ...
                    <div class="col-md-12" style="margin-bottom: 10px;" id="vhl_type_select">
                        ...
                        <div class="col-md-4 vhl_opt" id="vhl_opt_1">
                            <div class="form-group">
                                <label for="opt_1">Type of vehicle</label><label class="pull-right" for="opt_1">نوع السيارة</label>

                                <input type="text" class="form-control" id="opt_1_display" value="{{ $opt_1->value ?? '' }}" readonly="">
                            </div>

                        </div>

                        <div class="col-md-4 vhl_opt" id="vhl_opt_2">
                            <div class="form-group">
                                <label for="opt_1">Body Type</label><label class="pull-right" for="opt_2">شكل الهيكل</label>

                                <input type="text" class="form-control" id="opt_2_display" value="{{ $opt_2->value ?? '' }}" readonly="">
                            </div>

                        </div>

                        <div class="col-md-4 vhl_opt" id="vhl_opt_3">
                            <div class="form-group">
                                <label for="opt_1">Cylinder</label><label class="pull-right" for="opt_3">عدد السلندرات</label>

                                <input type="text" class="form-control" id="opt_3_display" value="{{ $opt_3->value ?? '' }}" readonly="">
                            </div>
                        ...
                        <div class="col-md-4 vhl_opt" id="vhl_opt_1">
                            <div class="form-group">
                                <label for="opt_1">No. of seats</label><label class="pull-right" for="opt_1">عدد الركاب</label>

                                <input type="text" class="form-control" id="passengers_display" value="{{ $insurance->passengers ?? '' }}" readonly="">
                            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" id="qatarBimaxtra" style="">
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 radio">
                                    <label><input type="radio" class="add_opt_radio" value="0" data-amount="0" {{ ($insurance->add_opt ?? 0) == 0 ? 'checked' : '' }}>&nbsp;None</label><br>
                                    <label><input type="radio" class="add_opt_radio" value="17" data-amount="220" {{ ($insurance->add_opt ?? 0) == 17 ? 'checked' : '' }}>&nbsp;For 5 Days</label><br>
                                    <label><input type="radio" class="add_opt_radio" value="18" data-amount="270" {{ ($insurance->add_opt ?? 0) == 18 ? 'checked' : '' }}>&nbsp;For 10 Days</label><br>
                                    <label><input type="radio" class="add_opt_radio" value="19" data-amount="350" {{ ($insurance->add_opt ?? 0) == 19 ? 'checked' : '' }}>&nbsp;For 15 Days</label><br>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container bordered-container" style="max-width:500px">
                            <div class="form-group">
                                ...
                                <div id="calcMethodShow">
                                    <label id="base-amt" style="display:block;">Insurance
                                        Premium&nbsp;:&nbsp;QAR&nbsp;<span>{{ number_format($insurance->base_amount ?? 0, 2) }}</span></label><br/>
                                    <label id="pass-amt" style="display:block;">Passenger
                                        Price&nbsp;:&nbsp;QAR&nbsp;<span>{{ number_format($insurance->pass_amount ?? 0, 2) }}</span></label><br/>
                                    <label id="opt-amt1" style="display:block;">Replacement
                                        Car&nbsp;:&nbsp;QAR&nbsp;<span>{{ number_format($insurance->opt_amount ?? 0, 2) }}</span></label>
                                </div>
                                <h6 id="NetAmount" style="display: block; padding-top:10px;"><b>Net Amount : QAR <span
                                                id="totalPrice">{{ number_format($insurance->total_amount ?? 0, 2) }}</span></b></h6>
                                <hr>
                                <span id="discontShow"
                                      style="display: block">Special Discount ({{$discount*100 }} %) : <span
                                            id="discountAmt">{{ number_format($insurance->discount ?? 0, 2) }}</span></span>
                                <h5 style="color:#b50555"><b>Grand Total : QAR <span
                                                id="grandTotalPrice">{{ number_format($insurance->total_amount ?? 0, 2) }}</span></b></h5><br>
                            </div>
                            <div class="form-group">
...
@section('script')
    <script>
        ...
        $(document).ready(function () {
            // Set owner type based on insurance data
            @if(isset($insurance) && $insurance->owner_type)
                $('input[name="owner_type"][value="{{ $insurance->owner_type }}"]').prop('checked', true).trigger('change');
            @endif
            
            // Update hidden add_opt field when radio buttons change
            $('.add_opt_radio').on('change', function() {
                $('input[name="add_opt"]').val($(this).val());
            });
