  ...
  <form id="thirdPartFrm" autocomplete="off" name="thirdPartFrm" action="/insurance/addThirdparty" method="post">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="radio">
              <label style="display:block"><input type="radio" name="owner_type" value="I" checked> Individual (شخصى)</label>
          </div>
        </div>
        <div class="col-md-9">
          <div class="radio">
              <label style="display:block"><input type="radio" name="owner_type" value="O"> Organisation (مؤسسة)</label>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="nmi_fullname" id="chngeOwnerF">Full Name</label><label class="pull-right" for="nmi_fullname">الاسم الكامل</label>
            <input type="text" class="form-control" name="name" id="nmi_fullname">
          </div>
        </div>
        <div class="col-md-4" id="establishQ">
          <div class="form-group">
            <label for="qid" id="chngeOwnerQ">Qatar ID</label><label class="pull-right" for="qid">رقم البطاقة</label>
            <input value="" type="text" class="form-control" name="qid" id="qid" maxlength="11">
          </div>
        </div>
        <div class="col-md-4" id="establishE" style="display:none;">
          <div class="form-group">
            <label for="eid" id="chngeOwnerQ">Establishment ID</label><label class="pull-right" for="nmi_fullname">بطاقة قيد المنشأة</label>
            <input type="text"  value="" class="form-control" name="eid" id="eid" maxlength="8">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            <label for="nmi_email">Email</label><label class="pull-right" for="email">البريد الإلكتروني</label>
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label for="mobile">Mobile #</label><label class="pull-right" for="mobile">رقم الجوال</label>
            <input type="tel" class="form-control" id="mobile" name="mobile" maxlength="8">
          </div>
        </div>
        <div class="col-md-4" id="posboxOrg" style="display: none;">
          <div class="form-group">
            <label for="pb_no">P.O Box #</label><label class="pull-right" for="pb_no">صندوق البريد</label>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="vhl_make">Make</label><label class="pull-right" for="vhl_make">نوع السيارة</label>
              <select id="vhl_make" class="form-control" name="vhl_make">
                <option value="">--Select--</option>
                <?php //foreach ($make as $result): ?><!---->
                <option value="<?php //= $result['vehicle_make'] ?><!---->" data-id="<?php //= $result['id'] ?><!---->"><?php //= $result['vehicle_make'] ?><!----></option>
                <?php //endforeach; ?><!---->
              </select>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="vhl_class">Model</label><label class="pull-right" for="vhl_class">الموديل</label>
            ...
            <div class="col-md-4">
              <div class="form-group">
                  <label for="vhl_reg_no">Vehicle Plate #</label><label class="pull-right" for="vhl_reg_no">رقم السيارة</label>
                  <input type="text" class="form-control" name="vhl_reg_no" id="vhl_reg_no">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="vhl_color">Color</label><label class="pull-right" for="vhl_color">اللون</label>
                <select class="form-control" name="vhl_color" id="vhl_color">
                  <?php //foreach ($colors as $color): ?><!---->
                  <option  value="<?php //= $color['color'] ?><!---->"><?php //= $color['color'] ?><!----></option>
                  <?php //endforeach; ?><!---->
                </select>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <label for="vhl_year">Year of Manufacture</label><label class="pull-right" for="vhl_year">سنة الصنع</label>
                <select class="form-control" name="vhl_year" id="vhl_year">
                  <option>Select Year</option>
                  <?php //for ($y = $tenYearBack; $y <= $currentYear; $y++) { ?><!---->
                      <option value="<?php //= $y; ?><!---->"><?php //= $y; ?><!----></option>
                  <?php //} ?><!---->
                </select>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
                <label for="start_date">Start date </label><label class="pull-right" for="start_date"></label>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12" id="insMain">
              <div class="form-group">
                <?php //foreach ($insCompany as $result): ?><!---->
                  <div class="col-md-3" style="padding: .35rem .25rem;">
                    <h6 style="font-size:14px"><?php //= $result['name'] ?><!----></h6>
                    <a class="insurance_logo" <?php //= ($result['active'] == 0) ? 'style="pointer-events:none;filter: contrast(0.7);"' : '' ?><!----> data-id="<?php //= $result['id'] ?><!---->">
                      <img src="/assets/img/insurancelogos/<?php //= $result['logo'] ?><!---->" alt="<?php //= $result['name'] ?><!---->" class="img-uploads img-thumbnail">
                    </a>
                  </div>
                <?php //endforeach; ?><!---->
            ...
            <div class="col-md-4 vhl_opt" id="vhl_opt_1">
              <div class="form-group">
                ...
                <select class="form-control" name="opt_1" id="opt_1">
                  ...
                  <?php //foreach ($vhlTypes as $result): ?><!---->
                      <option value="<?php //= $result['id'] ?><!---->" data-name="<?php //= $result['name'] ?><!---->" data-ar-name="<?php //= $result['ar_name'] ?><!---->"><?php //= $result['value'] ?><!----></option>
                  <?php //endforeach; ?><!---->
                </select>
              </div>
            </div>
              ...
              <p style="font-weight:500">D. Select additional Qatar Bima services [Optional]</p>
                <div class="row">
                  ...
                  <div class="col-md-3 radio">
                    <label><input type="radio" name="add_opt" id="repacementXtra0" value="0" data-amount="0" checked>&nbsp;None</label><br/>
                    <?php //foreach ($qb_opt as $result): ?><!---->
                      <label><input type="radio" name="add_opt" value="<?php //= $result['id'] ?><!---->" data-amount="<?php //= $result['amount'] ?><!---->">&nbsp;<?php //= $result['name'] ?><!----></label><br>
                    <?php //endforeach; ?><!---->
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="container bordered-container" style="max-width:500px">
              <div class="form-group">
                ...
                <hr>
                <span id="discontShow" style="display: none">Special Discount (<?php //= $discount*100 ?><!----> %) : <span id="discountAmt"></span></span>
                <h5 style="color:#b50555"><b>Grand Total : QAR <span id="grandTotalPrice">0.00</span></b></h5><br>
              </div>
              <div class="form-group">
                  <label for="exampleFormControlInput1"></label>
                  <input type="button" class="btn btn-dark" name="cancel" id="cancel" value="Cancel (إلغاء)">
                  <input type="submit" class="btn btn-common" name="submit" id="submit" value="Next (التالى)">
              </div>
            </div>
          </div>
        </div>
      ...
      if( curId != 'passengers' ){
        ...
        if( final == 1 ) {
          ...
          $.get("/insurance/getPrice/"+nextOpt, function(data) {
            ...
            let optionsData = JSON.parse(data);
